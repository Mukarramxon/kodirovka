...
export default function ReleaseManagement() {
  ...
  const tabs = [
    { id: 'mobile', label: 'Mobile Platform', icon: Smartphone },
    { id: 'web', label: 'Web / Product Teams', icon: Globe },
  ];
  ...
  return (
    <section>
        ...
        <div className="flex gap-1 p-1 bg-slate-100 rounded-xl w-fit">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <TabIcon className={`w-4 h-4 ${isActive ? 'text-primary-600' : 'text-slate-400'}`} />
                {tab.label}
              </button>
            );
          })}
      ...
      {activeTab === 'mobile' && (
        <div>
          <h3 id="release-jira" className="text-lg font-semibold text-slate-900 mb-4 scroll-mt-20 flex items-center gap-2">
      ...
      {/* Web / Product Teams Tab */}
      {activeTab === 'web' && (
        <div>
          <h3 id="release-web-teams" className="text-lg font-semibold text-slate-900 mb-4 scroll-mt-20 flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-primary-500" />
            Инструкция по релизам в Jira для web / продуктовых команд
          </h3>
            ...
            <div className="space-y-6">
              <div className="bg-primary-50 rounded-lg p-4 border border-primary-100">
                <div className="flex items-start gap-3">
                  <Info className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" />
                  <p className="text-sm text-primary-800 font-medium leading-relaxed">
                    В web / продуктовых командах <span className="font-bold">Fix Version</span> ставится на <span className="font-bold">Story</span>.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="bg-slate-50 rounded-lg p-4 border border-slate-100">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-slate-700">
                        Fix Version присваивается перед переводом Story в статус <Badge variant="success">Ready for Prod</Badge>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50 rounded-lg p-4 border border-slate-100">
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-emerald-500 mt-0.5 flex-shrink-0" />
                      <p className="text-sm text-slate-700">
                        Story, на которую поставлен Fix Version, должна <span className="font-semibold">реально входить в релиз</span>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-amber-50 rounded-lg p-4 border border-amber-100">
                    <div className="flex items-start gap-2">
                      <GitBranch className="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" />
                      <p className="text-sm text-amber-800">
                        <span className="font-semibold">Ключ ветки</span> в Git должен совпадать с ключом Story, на которой стоит Fix Version.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-rose-50 rounded-lg p-4 border border-rose-100">
                <div className="flex items-start gap-3">
                  <Flag className="w-5 h-5 text-rose-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="text-sm font-semibold text-rose-800 mb-2">Если на этапе тестирования найден дефект</p>
                    <div className="space-y-2 text-sm text-rose-700">
                      <div className="flex items-start gap-2">
                        <span className="mt-0.5">1.</span>
                        <span>Ставится <span className="font-semibold">красный флаг</span> на Story</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="mt-0.5">2.</span>
                        <span>После исправления дефекта и успешной повторной проверки красный флаг <span className="font-semibold">снимается</span></span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="mt-0.5">3.</span>
                        <span>Story переводится в статус <Badge variant="success">Ready for Prod</Badge></span>
                      </div>
                    </div>
                  </div>
                </div>
